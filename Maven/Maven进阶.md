...
假如 A依赖B，B依赖 `maven_03_pojo`。B中的pom文件中 **optional值为 tru**e，那么在A中，`maven_03_pojo` 不可见。
...
2. 在 **maven-public** 这个 group 类型的仓库中：
...
![image-20220423210310406](assets/image-20220423210310406.png)
